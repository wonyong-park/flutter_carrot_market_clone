...
class ManorTemperatureWidget extends StatelessWidget {
  ...
  ManorTemperatureWidget({Key? key, required this.manorTemp}) : super(key: key){
    _calcTempLevel();
  }
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                width: 30,
                height: 30,
                child: Image.asset("images/level-$level.jpg"),
              )
            ],
          ),
          const Text(
  ...
  Widget _makeTempLabelAndBar(){
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text("${manorTemp}°C", style: TextStyle(color: tempPerColors[level], fontSize: 18, fontWeight: FontWeight.bold),),
          ClipRRect(
